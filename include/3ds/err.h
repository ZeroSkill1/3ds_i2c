#ifndef _I2C_3DS_ERR_H
#define _I2C_3DS_ERR_H
...
#define TIS(failure) do {Result __tmp = failure; if (R_FAILED(__tmp) && (R_LEVEL(__tmp) != RL_INFO || R_LEVEL(__tmp) != RL_STATUS)) Err_Throw(__tmp);} while(0);
