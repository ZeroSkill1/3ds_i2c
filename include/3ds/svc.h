#ifndef _I2C_3DS_SVC_H
#define _I2C_3DS_SVC_H
...
Result svcBindInterrupt(u32 interrupt, Handle target, s32 priority, bool isManualClear);
Result svcUnbindInterrupt(u32 interrupt, Handle taget);
